    ...
    <div className="flex flex-col h-full overflow-hidden" style={{ background: "rgba(0,0,0,0.55)", backdropFilter: "blur(2px)" }}>
      ...
      <div className="flex items-center justify-between px-6 pt-5 pb-4 flex-shrink-0">
        <div>
          ...
          <p className="text-[11px] pl-7 mt-0.5" style={{ color: "rgba(255,255,255,0.5)" }}>
            Из канала @sb7games
          </p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6">
        {loading ? (
          <div className="flex items-center justify-center h-40 gap-2" style={{ color: "rgba(255,255,255,0.5)" }}>
          ...
          >
            ...
            >
              ...
              <div className="p-5 overflow-y-auto flex flex-col gap-3">
                ...
                <p className="text-[10px]" style={{ color: "rgba(255,255,255,0.45)" }}>{detail.date}</p>
              </div>
            </motion.div>
          </motion.div>
        )}
...
function NewsCard({ item, i, onClick }) {
  return (
    <motion.div
      ...
      onMouseEnter={e => { e.currentTarget.style.background = "rgba(17,17,17,0.75)"; }}
    ...
    >
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        >
          <span className="text-[9px]" style={{ color: "rgba(255,255,255,0.45)" }}>{item.date}</span>
...
function NoNews() {
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-4">
      ...
      <p className="text-[13px]" style={{ color: "rgba(255,255,255,0.45)" }}>Нет новостей</p>
