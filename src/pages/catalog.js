...
export const LIBRARY_CATALOG = [
  ...
  { id: "bg_fon1",           type: "background", name: "",                       price: 0,    color: "#3b82f6",  rarity: "common",    free: true, video: `${CDN}/backgrounds/fon1.mp4${CACHE_BUST}` },
  { id: "bg_fon2",           type: "background", name: "",                       price: 500,  color: "#8b5cf6",  rarity: "rare",      video: `${CDN}/backgrounds/fon2.mp4${CACHE_BUST}` },
  { id: "bg_fon3",           type: "background", name: "",                       price: 800,  color: "#ec4899",  rarity: "rare",      video: `${CDN}/backgrounds/fon3.mp4${CACHE_BUST}` },
  { id: "bg_fon4",           type: "background", name: "",                       price: 1200, color: "#f97316",  rarity: "epic",      video: `${CDN}/backgrounds/fon4.mp4${CACHE_BUST}` },
  { id: "bg_fon5",           type: "background", name: "",                       price: 1500, color: "#eab308",  rarity: "epic",      video: `${CDN}/backgrounds/fon5.mp4${CACHE_BUST}` },
  { id: "bg_fon6",           type: "background", name: "",                       price: 2000, color: "#22c55e",  rarity: "legendary", video: `${CDN}/backgrounds/fon6.mp4${CACHE_BUST}` },
  { id: "bg_fon7",           type: "background", name: "",                       price: 2500, color: "#06b6d4",  rarity: "legendary", video: `${CDN}/backgrounds/fon7.mp4${CACHE_BUST}` },
  { id: "bg_fon8",           type: "background", name: "",                       price: 600,  color: "#f43f5e",  rarity: "rare",      video: `${CDN}/backgrounds/fon8.mp4${CACHE_BUST}` },
  { id: "bg_fon9",           type: "background", name: "",                       price: 700,  color: "#8b5cf6",  rarity: "rare",      video: `${CDN}/backgrounds/fon9.mp4${CACHE_BUST}` },
  { id: "bg_fon10",          type: "background", name: "",                       price: 900,  color: "#ec4899",  rarity: "rare",      video: `${CDN}/backgrounds/fon10.mp4${CACHE_BUST}` },
  { id: "bg_fon11",          type: "background", name: "",                       price: 1100, color: "#f97316",  rarity: "epic",      video: `${CDN}/backgrounds/fon11.mp4${CACHE_BUST}` },
  { id: "bg_fon12",          type: "background", name: "",                       price: 1300, color: "#eab308",  rarity: "epic",      video: `${CDN}/backgrounds/fon12.mp4${CACHE_BUST}` },
  { id: "bg_fon13",          type: "background", name: "",                       price: 1500, color: "#22c55e",  rarity: "epic",      video: `${CDN}/backgrounds/fon13.mp4${CACHE_BUST}` },
  { id: "bg_fon14",          type: "background", name: "",                       price: 1800, color: "#06b6d4",  rarity: "epic",      video: `${CDN}/backgrounds/fon14.mp4${CACHE_BUST}` },
